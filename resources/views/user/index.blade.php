                            ...
                            <div class="x_title">
                                ...
                                <div class="float-right ml-auto">
                                    <button type="button" class="btn btn-primary" data-toggle="modal"
                                        data-target="#modalFormUserManager">
                                        Tambah User Manager
                                    </button>
...
@push('script')
    ...
    $('#modalFormUserManager').on('show.bs.modal', function(e) {
        ...
        if(mode === 'edit'){
            ...
            modal.find('.modal-title').text('Input Data User Manager')
            modal.find('#name').val('')
