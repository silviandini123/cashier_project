                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <select name="jenis_id" class="form-control">
                                                    <option value="1" {{ Request::get('jenis_id') == 'tea' }}>Tea
                                                    </option>
                                                    <option value="2" {{ Request::get('jenis_id') == 'coffe' }}>Coffe
                                                    </option>
                                                    <option value="3" {{ Request::get('jenis_id') == 'non coffe' }}>
                                                        Non Coffe</option>
                                                    <option value="4" {{ Request::get('jenis_id') == 'dessert' }}>
                                                        Dessert</option>
                                                    <option value="5" {{ Request::get('jenis_id') == 'pasta' }}>Pasta
                                                    </option>
                                                    <option value="6"
                                                        {{ Request::get('jenis_id') == 'main course' }}>Main Course</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
